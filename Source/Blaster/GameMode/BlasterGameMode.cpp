...
void ABlasterGameMode::OnMatchStateSet()
{
	...
	//UE_LOG(LogTemp, Warning, TEXT(" BLASTERGAMEMODE.CPP LINE 61: bTeamsMatch value: %s"), bTeamsMatch ? TEXT("True") : TEXT("False")); // tomato
	for (FConstPlayerControllerIterator It = GetWorld()->GetPlayerControllerIterator(); It; ++It)
	{
		ABlasterPlayerController* BlasterPlayer = Cast<ABlasterPlayerController>(*It);
		if (BlasterPlayer)
		{	UE_LOG(LogTemp, Warning, TEXT(" BLASTERGAMEMODE.CPP LINE 61: bTeamsMatch value: %s"), bTeamsMatch ? TEXT("True") : TEXT("False")); // tomato
			BlasterPlayer->OnMatchStateSet(MatchState, bTeamsMatch); // tomato
		}
	}
}
