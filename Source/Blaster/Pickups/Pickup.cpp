...
void APickup::Tick(float DeltaTime)
{
	...
	if (PickupMesh)
	{
		PickupMesh->AddLocalRotation(FRotator(BaseTurnRate * DeltaTime, BaseTurnRate * DeltaTime, BaseTurnRate * DeltaTime)); // i think vertical this shit and make it go up and down and spin....
	}
}
