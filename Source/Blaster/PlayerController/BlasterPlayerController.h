...
protected:
	...
	*/
	...
	class UInputAction* ReturnMainMenuAction;
	...
	*/
	...
	// Requests the current server time, passing in the clietn's time when the request was sent
	...
	UFUNCTION(Client, Reliable)
	void ClientJoinMidGame(FName StateOfMatch, float StartingTime, float Warmup, float Match, float Cooldown);
